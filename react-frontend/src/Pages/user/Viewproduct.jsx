...
export default function Viewproduct() {
    ...
    return (
        <div className="w-full h-auto">
            <div className="w-full flex justify-center m-auto h-[70vh] items-center bg-white rounded shadow-sm">
                ...
                <div className="h-3/5 w-[40%] justify-center items-center text-center flex flex-col" >
                    ...
                    <Link to="/order" className="bg-green-800 text-white px-14 py-3 mt-4 text-center text-xl w-[50%] hover:bg-green-700 rounded">
                        Order Now
                    </Link>
